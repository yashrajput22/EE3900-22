...
\\
\solution  The graph is symmetric and periodic it is attending high of value 4 and minimum between (0 - 0.5). From uniformly spaced samples it produces a function of frequency that is a periodic summation of the continuous Fourier transform of the original continuous function 
\\
...
\\
\solution Yes, it is bounded and convergent. We can clearly see in the plot it is not tending to infinite and remain finite.
\\
